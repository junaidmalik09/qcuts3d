...
[GVMean, suppixel, boundaries,PixNum, LabelLine,width, height]=SolveSlic(image_now,suppix_size,m);
...
H=UpdateDiagonal(GVMean,bkg,H,boundaries);

%Calculate Saliency Map
SalMap=QCUT(H,smooth,PixNum, suppixel,width, height);
